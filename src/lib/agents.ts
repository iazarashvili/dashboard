...
export const agents: AgentConfig[] = [
  ...
  },
  {
    ...
    description:
      "manual_output.json-ის მიხედვით Playwright ტესტის კოდის გენერაცია (auto-detects manual_output.json in project path)",
    icon: "FileCode",
    color: "blue",
    promptFile: "automatization-tests/write-test.md",
  ...
  },
  {
    ...
    icon: "Wrench",
    color: "amber",
    promptFile: "automatization-tests/fix-test.md",
